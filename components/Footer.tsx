        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12">
          ...
          <div className="space-y-3">
            <a
              ...
              className="flex items-start gap-3 text-white/50 hover:text-white transition-colors font-body text-sm"
            >
            ...
            <a
              href="tel:8176337500"
              className="flex items-center gap-3 text-brand-red hover:text-red-400 transition-colors font-body font-bold text-sm"
            >
          ...
          {/* Hours */}
          <div className="font-body text-sm text-white/40 space-y-1.5">
            <p className="text-white/60 font-semibold mb-2">Hours</p>
